...
namespace RandomizerMod.RC
{
    public static class LogicConstUtil
    {
        ...
        static LogicConstUtil()
        {
            ...
            _charmTerms = JsonUtil.Deserialize<Dictionary<string, List<string>>>("RandomizerMod.Resources.Logic.terms.json")["SignedByte"].SkipWhile(t => t != "Gathering_Swarm").Take(40).ToArray();
